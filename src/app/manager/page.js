...
// English-friendly canonical URL for the same dashboard. /box (FR) and
// /manager (EN) both render this — components that link to it pick the URL
// matching the active language so the bar shows /manager for EN visitors.
